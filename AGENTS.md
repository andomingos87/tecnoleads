...
## Repository map
- `backlog_mvp.md/` — explain what lives here and when agents should edit it.
- `design_spec.md/` — explain what lives here and when agents should edit it.
- `prd.md/` — explain what lives here and when agents should edit it.
- `regras.md/` — explain what lives here and when agents should edit it.
- `stack.md/` — explain what lives here and when agents should edit it.
